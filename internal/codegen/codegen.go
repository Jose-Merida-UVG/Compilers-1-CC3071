...
//   sourcePath — path to the original .yal file, read to extract the optional
//                header / trailer sections that are copied verbatim.
...
func GenerateLexer(name, sourcePath string, dfa *automata.DFA, actions []string) string {
	...
	// Best-effort: pull header / trailer from the spec file.
	header, trailer := "", ""
	if yf, err := yalex.ParseYalFile(sourcePath); err == nil {
		header = yf.Header
		trailer = yf.Trailer
	}
	...
	// ── file preamble ──────────────────────────────────────────────────────
	w("// Code generated by YALex from %s. DO NOT EDIT.\n", sourcePath)
	w("package lexers\n\n")
